...
class EATA(BaseAdaptation):
    ...
    def run_multiple_steps(
        ...
        for step in range(1, nbsteps + 1):
            ...
            # print("model_selection_method:", model_selection_method)
            # print("model_selection_method.save_state:", model_selection_method.save_state)

            # print("model", copy.deepcopy(model).state_dict(),
            #                     "step",step,
            #                     "lr",self._meta_conf.lr,
            #                     # **adaptation_result,
            #                     )
            print(copy.deepcopy(model).state_dict().loss)
