...
try:
    ...
    warnings.warn(
        "Wand is not installed, so some of the synthetic corruptions will not be available."
    )
...
# In Cifar-C, they use 15 kinds of corruptions, and the severity is 1-5
...
def impulse_noise(x, random_state, severity=1):
    ...
    # To apply the same random noise onto all images, comment this line and uncomment next two lines.
