...
def get_args():
    ...
    parser.add_argument("--data_path", default="/data/TTA-exp/ttab/datasets", type=str)
    parser.add_argument(
        "--ckpt_path",
        default="/data/TTA-exp/TTAB-jiang/ttab-main/ttab-benchmarkData/rn26_iabn.pth",
        type=str, #./pretrained_ckpts/classification/wideresnet_with_head/cifar10/wrn28_bn.pth
    )
    ...
    parser.add_argument("--model_name", default="resnet26", type=str) #resnet26
    ...
    parser.add_argument(
        "--data_names", default="cifar10_c_deterministic-gaussian_noise-5;"
